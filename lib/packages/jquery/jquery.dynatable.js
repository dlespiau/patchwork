...
(function($) {
  ...
  function SortsHeaders(obj, settings) {
    ...
    this.appendArrowUp = function($link) {
      ...
      $link.append("<span class='dynatable-arrow dropup'><span class='caret'></span></span> ");
    };

    this.appendArrowDown = function($link) {
      this.removeArrow($link);
      $link.append("<span class='dynatable-arrow caret'></span> ");
    };
    ...
    this.toggleSort = function(e, $link, column) {
      ...
      // If sorts for this column are already set and is ascending, then make
      // descending
      if (sortedByColumn && value == 1) {
  ...
  function PaginationLinks(obj, settings) {
    ...
    this.create = function() {
      ...
      pageLinks = '<ul class="' + 'dynatable-pagination-links-' + obj.element.id + ' ' + settings.inputs.paginationClass + '"' + display + '>';
